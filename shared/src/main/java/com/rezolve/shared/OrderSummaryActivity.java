...
public class OrderSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueShoppingButton.setOnClickListener(view -> navigateToMainView());
    ...
    private void getOrderDetails(String orderId) {
        UserActivityManager userActivityManager = RezolveSDK.peekInstance()
                .getRezolveSession()
    ...
    private void navigateToMainView() {
        Intent intent = new Intent(OrderSummaryActivity.this, ((MainActivityProvider)getApplicationContext()).getMainActivity());
